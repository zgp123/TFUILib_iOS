...
@interface TFCardLayout ()
{
    CGFloat _viewHeight;
    CGFloat _itemHeight;
}

@property (nonatomic) TFCardAnimType carouselAnim;

@end

@implementation TFCardLayout
